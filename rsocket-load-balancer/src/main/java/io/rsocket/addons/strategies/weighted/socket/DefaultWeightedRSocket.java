...
public class DefaultWeightedRSocket extends RSocketProxy implements WeightedRSocket {
    ...
    public DefaultWeightedRSocket(WeightedRSocketPoolStatistics weightedRSocketPoolStatistics, RSocket rSocket) {
    ...
    public Mono<Double> algorithmicWeight() {
        ...
        return weightedRSocketPoolStatistics
                .getQuantiles()
                .flatMap(quantiles -> concurrentSubscriptionTracker.consume(
