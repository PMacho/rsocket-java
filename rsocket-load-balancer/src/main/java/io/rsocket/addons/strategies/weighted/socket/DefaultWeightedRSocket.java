...
public class DefaultWeightedRSocket extends RSocketProxy implements WeightedRSocket {
  ...
  public DefaultWeightedRSocket(
    ...
    this.concurrentSubscriptionTracker =
        Optional.ofNullable(inactivityFactor)
    ...
    logger.debug(
        "Creating WeightedRSocket {} for RSocket {}", DefaultWeightedRSocket.this, rSocket);
  }

  public DefaultWeightedRSocket(
      WeightedRSocketPoolStatistics weightedRSocketPoolStatistics, RSocket rSocket) {
  ...
  //        this.interArrivalTime = new Ewma(1, TimeUnit.MINUTES,
  // DEFAULT_INITIAL_INTER_ARRIVAL_TIME);
  //        this.pendingStreams = new AtomicLong();
  //
  //        logger.debug("Creating WeightedSocket {} from factory {}", WeightedSocket.this,
  // factory);
  //
  //        WeightedSocket.this
  //                .onClose()
  ...
  //                            logger.debug(
  //                                    "Removed {} from factory {} from activeSockets",
  // WeightedSocket.this, factory);
  //                        })
  //                .subscribe();
  //
  //        factory
  //                .get()
  //                .retryBackoff(weightedSocketRetries, weightedSocketBackOff,
  ...
  //                                    .isDisposed()) { // May be already disposed because of
  // retryBackoff delay
  //                                activeSockets.add(WeightedSocket.this);
  //                                logger.debug(
  //                                        "Added WeightedSocket {} from factory {} to
  // activeSockets",
  //                                        WeightedSocket.this,
  //                                        factory);
  //                            }
  ...
  public Mono<Double> algorithmicWeight() {
    ...
    return weightedRSocketPoolStatistics
        ...
        .flatMap(
            quantiles ->
                concurrentSubscriptionTracker.consume(
                    tracker ->
                        WeightingStatisticsUtil.algorithmicWeight(
  ...
  /**
   * Subscriber wrapper used for stream like interaction model, it only counts the number of active
   * streams
   */
